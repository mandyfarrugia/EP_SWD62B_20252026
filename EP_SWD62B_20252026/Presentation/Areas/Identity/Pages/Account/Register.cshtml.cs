...
namespace Presentation.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "First name must be less than less than 100 characters", MinimumLength = 1)]
            public string FirstName { get; set; }

            [Required]
            [StringLength(100, ErrorMessage = "Last name must be less than less than 100 characters", MinimumLength = 1)]
